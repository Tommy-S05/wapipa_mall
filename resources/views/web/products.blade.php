            ...
            <div class="row">
                ...
                <div class="col-lg-9 order-1">
                    <div class="shop-banner img-full">
                        <img src="{{ asset('galio/assets/img/banner/banner_static1.jpg') }}" alt="">
                    </div>
                        ...
                        <div class="shop-product-wrap grid row">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <div class="product-list-item mb-30">
                                    ...
                                    <div class="product-list-content">
                                        <h3><a href="galio/product-details.html">virtual product 02</a></h3>
                                        <div class="ratings">
                                            <span class="good"><i class="fa fa-star"></i></span>
                                            <span class="good"><i class="fa fa-star"></i></span>
                                            <span class="good"><i class="fa fa-star"></i></span>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <div class="product-list-item mb-30">
                                    ...
                                    <div class="product-list-content">
                                        <h3><a href="galio/product-details.html">simple product 02</a></h3>
                                        <div class="ratings">
                                            <span class="good"><i class="fa fa-star"></i></span>
                                            <span class="good"><i class="fa fa-star"></i></span>
                                            <span class="good"><i class="fa fa-star"></i></span>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <div class="product-item fix mb-30">
                                    ...
                                    <div class="product-content">
                                        <h4><a href="galio/product-details.html">group product 01</a></h4>
                                        <div class="pricebox">
                                            <span class="regular-price">$70.00</span>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                ...
                                <div class="product-list-item mb-30">
                                    ...
                                    <div class="product-list-content">
                                        <h3><a href="galio/product-details.html">group product 02</a></h3>
                                        <div class="ratings">
                                            <span class="good"><i class="fa fa-star"></i></span>
                                            <span class="good"><i class="fa fa-star"></i></span>
                                            <span class="good"><i class="fa fa-star"></i></span>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <div class="product-item fix mb-30">
                                    <div class="product-thumb">
                                        <a href="galio/product-details.html">
                                            <img src="{{ asset('galio/assets/img/product/product-img7.jpg') }}"
                                                 class="img-pri" alt="">
                                            <img src="{{ asset('galio/assets/img/product/product-img8.jpg') }}"
                                                 class="img-sec" alt="">
                                        </a>
                                        <div class="product-label">
                                            <span>hot</span>
                                    ...
                                    <div class="product-content">
                                        <h4><a href="galio/product-details.html">external product</a></h4>
                                        <div class="pricebox">
                                            <span class="regular-price">$70.00</span>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                ...
                                <div class="product-list-item mb-30">
                                    ...
                                    <div class="product-list-content">
                                        <h3><a href="galio/product-details.html">external product</a></h3>
                                        <div class="ratings">
                                            <span class="good"><i class="fa fa-star"></i></span>
                                            <span class="good"><i class="fa fa-star"></i></span>
                                            <span class="good"><i class="fa fa-star"></i></span>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <div class="product-item fix mb-30">
                                    <div class="product-thumb">
                                        <a href="galio/product-details.html">
                                            <img src="{{ asset('galio/assets/img/product/product-img9.jpg') }}"
                                                 class="img-pri" alt="">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <div class="product-item fix mb-30">
                                    <div class="product-thumb">
                                        <a href="galio/product-details.html">
                                            <img src="{{ asset('galio/assets/img/product/product-img11.jpg') }}"
                                                 class="img-pri"
                                                 alt="">
                                    ...
                                    <div class="product-content">
                                        <h4><a href="galio/product-details.html">smart product 01</a></h4>
                                        <div class="pricebox">
                                            <span class="regular-price">$70.00</span>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                ...
                                <div class="product-list-item mb-30">
                                    ...
                                    <div class="product-list-content">
                                        <h3><a href="galio/product-details.html">smart product 02</a></h3>
                                        <div class="ratings">
                                            <span class="good"><i class="fa fa-star"></i></span>
                                            <span class="good"><i class="fa fa-star"></i></span>
                                            <span class="good"><i class="fa fa-star"></i></span>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <div class="product-item fix mb-30">
                                    <div class="product-thumb">
                                        <a href="galio/product-details.html">
                                            <img src="{{ asset('galio/assets/img/product/product-img13.jpg') }}"
                                                 class="img-pri"
                                                 alt="">
                                            <img src="{{ asset('galio/assets/img/product/product-img14.jpg') }}"
                                                 class="img-sec"
                                                 alt="">
                                        </a>
                                        <div class="product-label">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <div class="product-item fix mb-30">
                                    <div class="product-thumb">
                                        <a href="galio/product-details.html">
                                            <img src="{{ asset('galio/assets/img/product/product-img15.jpg') }}"
                                                 class="img-pri"
                                                 alt="">
                                            <img src="{{ asset('galio/assets/img/product/product-img16.jpg') }}"
                                                 class="img-sec"
                                                 alt="">
                                        </a>
                                        <div class="product-label">
